                ...
                <div class="row">
                    <div class="box box-primary box-solid" id="rb">
                        <div class="box-header with-border">
                            <form method="post" action="<?= base_url();?>monitoring/ppk">
                            <h3 class="box-title text-light">
                                <i class="fa fa-table"></i> Daftar PPK     
                                <select class="box-header-select-year" id="thn_ppk" name="thn_ppk" onchange="submit()">
                                    <?
                        ...
                        <div class="tab-menu">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li <?= $kelompok == "tender" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/ppk/<?= "$thn/tender";?>#divider">Tender</a>
                                    </li>
                                    <li <?= $kelompok == "nontender" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/ppk/<?= "$thn/nontender";?>#divider">Non Tender</a>
                                    </li>
                                    <li <?= $kelompok == "pencatatan_nontender" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/ppk/<?= "$thn/pencatatan_nontender";?>#divider">Pencatatan Non Tender</a>
                                    </li>
                                    <li <?= $kelompok == "pencatatan_swakelola" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/ppk/<?= "$thn/pencatatan_swakelola";?>#divider">Pencatatan Swakelola</a>
                                    </li>
                                    <li <?= $kelompok == "epurchasing" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/ppk/<?= "$thn/epurchasing";?>#divider">ePurchasing</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="tab-inner">
                                        <div class="event-content">
                                            <div class="row aligncenter">
                                                <form method="post" action="<?= base_url();?>monitoring/ppk/<?= "$thn/$kelompok";?>#divider">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group input-group-sm search-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            ...
                                                            <a href="<?= base_url();?>laporan/proses/33/<?= "$thn/-/$kelompok/$getcari";?>" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Download Excel</a>
                                                        </span>
                                                    </div>
                                                </div>
                                                </form>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <ul class="pagination">
                                                        ...
                                                        <li class="page-item"><a href="<?= base_url(); ?>monitoring/ppk/<?= "$thn/$kelompok/1/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-backward"></i></a></li>
                                                        <li class="page-item"><a href="<?= base_url(); ?>monitoring/ppk/<?= "$thn/$kelompok/$link_prev/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-backward"></i></a></li>
                                                        <?
                                                            }
                                                            ...
                                                            for ($i = $start_number; $i <= $end_number; $i++) {
                                                                if ($page == $i) {
                                                                    ...
                                                                    $link_active = base_url() . "monitoring/ppk/$thn/$kelompok/$i/$limit/$getcari";
                                                        ...
                                                        <li class="page-item"><a href="<?= base_url(); ?>monitoring/ppk/<?= "$thn/$kelompok/$link_next/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-forward"></i></a></li>
                                                        <li class="page-item"><a href="<?= base_url(); ?>monitoring/ppk/<?= "$thn/$kelompok/$jumlah_page/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-forward"></i></a></li>
                                                        <? } ?>
                                                    </ul>
                                                    <? } ?>
                                                </div>
