                ...
                <div class="row">
                    <div class="box box-primary box-solid" id="rb">
                        <div class="box-header with-border">
                            <form method="post" action="<?= base_url();?>pencatatan/swakelola">
                            <h3 class="box-title text-light">
                                <i class="fa fa-table"></i> Daftar Swakelola   
                                <select class="box-header-select-year" id="thn_swakelola" name="thn_swakelola" onchange="submit()">
                                    <?
                        ...
                        <div class="box-body">
                            <div class="row aligncenter">
                                <form method="post" action="<?= base_url();?>pencatatan/swakelola/<?= "$thn";?>#rincian_belanja">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm search-group">
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            <a href="<?= base_url();?>laporan/proses/10/<?= "$thn/-/-/$getcari";?>" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Download Excel</a>
                                        </span>
                                    </div>
                                </div>
                                </form>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item"><a href="<?= base_url(); ?>pencatatan/swakelola/<?= "$thn/1/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-backward"></i></a></li>
                                        <li class="page-item"><a href="<?= base_url(); ?>pencatatan/swakelola/<?= "$thn/$link_prev/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-backward"></i></a></li>
                                        <?
                                            }
                                            ...
                                            for ($i = $start_number; $i <= $end_number; $i++) {
                                                if ($page == $i) {
                                                    ...
                                                    $link_active = base_url() . "pencatatan/swakelola/$thn/$i/$limit/$getcari";
                                        ...
                                        <li class="page-item"><a href="<?= base_url(); ?>pencatatan/swakelola/<?= "$thn/$link_next/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-forward"></i></a></li>
                                        <li class="page-item"><a href="<?= base_url(); ?>pencatatan/swakelola/<?= "$thn/$jumlah_page/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-forward"></i></a></li>
                                        <? } ?>
                                    </ul>
                                    <? } ?>
                                </div>
