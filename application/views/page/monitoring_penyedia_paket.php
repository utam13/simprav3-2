                    ...
                    <div class="box box-primary box-solid" id="provinsi">
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title text-light">
                                <i class="fa fa-table"></i> Daftar Paket Penyedia <?= $nama_penyedia;?> | Provinsi: <?= $provinsi;?> | Kabupaten/Kota: <?= $kabupaten_kota;?> | <?= $nama_kelompok;?> | Tahun: <?= $thn;?>
                            </h3>
                            <i class="close fa fa-times" onclick="location.href='<?= base_url();?>monitoring/daftar_penyedia/<?= $provinsi.'/'.$kabupaten_kota.'/'.$thn.'/'.$kelompok;?>'"></i>
                            </form>
                        </div>
                        <div class="box-body">
                            <div class="tab-menu">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li <?= $status == "aktif" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/aktif";?>#divider">Aktif</a>
                                    </li>
                                    <li <?= $status == "batal" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/batal";?>#divider">Batal</a>
                                    </li>
                                    <li <?= $status == "gagal" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/gagal";?>#divider">Gagal</a>
                                    </li>
                                    <li <?= $status == "selesai" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/selesai";?>#divider">Selesai</a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="tab-pane active">
                                    <div class="tab-inner">
                                        <div class="event-content">
                                            ...
                                            <form method="post" action="<?= base_url();?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/$status";?>#divider">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group input-group-sm search-group">
                                                    ...
                                                    <span class="input-group-btn">
                                                        ...
                                                        <a href="<?= base_url();?>laporan/proses/32/<?= "$thn/-/$status-$kd_penyedia-$provinsi-$kabupaten_kota-$nama_kelompok/$getcari";?>" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Download Excel</a>
                                                    </span>
                                                </div>
                                            </div>
                                            </form>
                                                ...
                                                <table class="table table-striped table-hover table-bordered table-sm table-normal">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td scope="col" nowrap class="text-right"><?= $d->pagu;?></td>
                                                            <td scope="col" nowrap class="text-right"><?= $d->nilai_kontrak;?></td>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <ul class="pagination">
                                                    ...
                                                    <li class="page-item"><a href="<?= base_url(); ?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/$status/1/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-backward"></i></a></li>
                                                    <li class="page-item"><a href="<?= base_url(); ?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/$status/$link_prev/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-backward"></i></a></li>
                                                    <?
                                                        }
                                                        ...
                                                        for ($i = $start_number; $i <= $end_number; $i++) {
                                                            if ($page == $i) {
                                                                ...
                                                                $link_active = base_url() . "monitoring/paket_penyedia/$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/$status/$i/$limit/$getcari";
                                                    ...
                                                    <li class="page-item"><a href="<?= base_url(); ?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/$status/$link_next/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-forward"></i></a></li>
                                                    <li class="page-item"><a href="<?= base_url(); ?>monitoring/paket_penyedia/<?= "$provinsi/$kabupaten_kota/$kelompok/$thn/$kd_penyedia/$status/$jumlah_page/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-forward"></i></a></li>
                                                    <? } ?>
                                                </ul>
                                                <? } ?>
                                            </div>
