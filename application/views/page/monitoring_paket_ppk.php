<div id="ppk" class="ppk-area area-padding">
                    ...
                    <div class="box box-primary box-solid" id="rb">
                        <div class="box-header with-border">
                            <h3 class="box-title text-light">
                                <i class="fa fa-table"></i> Daftar Paket <?= $nama_kelompok;?> PPK (<?= "$nip - $nama";?>) Tahun: <?= $thn;?>   
                            </h3>
                            <i class="close fa fa-times" onclick="location.href='<?= base_url();?>monitoring/ppk/<?= $thn;?>'"></i>
                        </div>
                        <div class="box-body">
                        <div class="tab-menu">
                                <!-- Nav tabs -->
                                <ul class="nav nav-tabs" role="tablist">
                                    <li <?= $status == "aktif" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/aktif";?>#divider">Aktif</a>
                                    </li>
                                    <li <?= $status == "batal" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/batal";?>#divider">Batal</a>
                                    </li>
                                    <li <?= $status == "gagal" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/gagal";?>#divider">Gagal</a>
                                    </li>
                                    <li <?= $status == "selesai" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/selesai";?>#divider">Selesai</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="tab-inner">
                                        <div class="event-content">
                                            <div class="row aligncenter">
                                                <form method="post" action="<?= base_url();?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/$status";?>#divider">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group input-group-sm search-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            ...
                                                            <a href="<?= base_url();?>laporan/proses/34/<?= "$thn/-/$status-$nip-$nama-$kelompok/$getcari";?>" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Download Excel</a>
                                                        </span>
                                                    </div>
                                                </div>
                                                </form>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <ul class="pagination">
                                                        ...
                                                        <li class="page-item"><a href="<?= base_url(); ?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/$status/1/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-backward"></i></a></li>
                                                        <li class="page-item"><a href="<?= base_url(); ?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/$status/$link_prev/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-backward"></i></a></li>
                                                        <?
                                                            }
                                                            ...
                                                            for ($i = $start_number; $i <= $end_number; $i++) {
                                                                if ($page == $i) {
                                                                    ...
                                                                    $link_active = base_url() . "monitoring/paket_ppk/$thn/$kelompok/$nip/$status/$i/$limit/$getcari";
                                                        ...
                                                        <li class="page-item"><a href="<?= base_url(); ?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/$status/$link_next/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-forward"></i></a></li>
                                                        <li class="page-item"><a href="<?= base_url(); ?>monitoring/paket_ppk/<?= "$thn/$kelompok/$nip/$status/$jumlah_page/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-forward"></i></a></li>
                                                        <? } ?>
                                                    </ul>
                                                    <? } ?>
                                                </div>
