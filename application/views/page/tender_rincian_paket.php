                ...
                <div class="row">
                    <div class="box box-primary box-solid" id="tender">
                        <div class="box-header with-border">
                            <form method="post" action="<?= base_url();?>tender/rincian_paket">
                        ...
                        <div class="tab-menu">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li <?= $kelompok == "total" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>tender/rincian_paket/<?= "$thn/total";?>#rincian_belanja">Total</a>
                                    </li>
                                    <li <?= $kelompok == "selesai" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>tender/rincian_paket/<?= "$thn/selesai";?>#rincian_belanja">Selesai</a>
                                    </li>
                                    <li <?= $kelompok == "berjalan" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>tender/rincian_paket/<?= "$thn/berjalan";?>#rincian_belanja">Berjalan</a>
                                    </li>
                                    <li <?= $kelompok == "batal" ? "class='active'":"";?> >
                                        <a href="<?= base_url();?>tender/rincian_paket/<?= "$thn/batal";?>#rincian_belanja">Batal</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="tab-inner">
                                        <div class="event-content">
                                            <div class="row aligncenter">
                                                ...
                                                <form method="post" action="<?= base_url();?>tender/rincian_paket/<?= "$thn/$kelompok";?>#rincian_belanja">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group input-group-sm search-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            ...
                                                            <a href="<?= base_url();?>laporan/proses/4/<?= "$thn/-/$kelompok/$getcari";?>" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Download Excel</a>
                                                        </span>
                                                    </div>
                                                </div>
                                                </form>
                                                    ...
                                                    <table class="table table-striped table-hover table-bordered table-sm table-normal">
                                                        <thead class="bg-light-blue">
                                                            <tr>
                                                                ...
                                                                <th scope="col" <?= $rowspan;?> nowrap class="text-center">Kode Paket</th>
                                                                ...
                                                                switch($kelompok){
                                                                    case "berjalan" :
                                                                ?>
                                                                <th scope="col" <?= $rowspan;?> nowrap class="text-center">Tanggal<br>Pembuatan<br>Tender</th>
                                                                <th scope="col" <?= $rowspan;?> nowrap class="text-center">Tanggal<br>Pengumuman<br>Tender</th>
                                                                <th scope="col" <?= $rowspan;?> nowrap class="text-center">Tanggal<br>Penetapan<br>Pemenang</th>
                                                                <th scope="col" <?= $rowspan;?> nowrap class="text-center">Tanggal<br>Tanda Tangan<br>Kontrak</th>
                                                                <th scope="col" <?= $rowspan;?> nowrap class="text-center">Pagu</th>
                                                                <th scope="col" <?= $rowspan;?> nowrap class="text-center">HPS</th>
                                                                <th scope="col" <?= $rowspan;?> nowrap class="text-center">Tahapan</th>
                                                                <?
                                                                        break;
                                                                    case "total":
                                                                    case "selesai":
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                switch($kelompok){
                                                                    case "berjalan":
                                                                ?>
                                                                <td scope="col" nowrap class="text-center"><?= $r->tanggal_pembuatan;?></td>
                                                                <td scope="col" nowrap class="text-center"><?= $r->tanggal_pengumuman_tender;?></td>
                                                                <td scope="col" nowrap class="text-center"><?= $r->tanggal_penetapan_pemenang;?></td>
                                                                <td scope="col" nowrap class="text-center"><?= $r->tanggal_ttd_kontrak;?></td>
                                                                <td scope="col" nowrap class="text-center"><?= $r->pagu;?></td>
                                                                <td scope="col" nowrap class="text-center"><?= $r->hps;?></td>
                                                                <td scope="col" nowrap class="text-center"><?= $r->tahapan;?></td>
                                                                <?
                                                                        break;
                                                                    case "total":
                                                                    case "selesai":
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <ul class="pagination">
                                                        ...
                                                        <li class="page-item"><a href="<?= base_url(); ?>tender/rincian_paket/<?= "$thn/$kelompok/1/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-backward"></i></a></li>
                                                        <li class="page-item"><a href="<?= base_url(); ?>tender/rincian_paket/<?= "$thn/$kelompok/$link_prev/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-backward"></i></a></li>
                                                        <?
                                                            }
                                                            ...
                                                            for ($i = $start_number; $i <= $end_number; $i++) {
                                                                if ($page == $i) {
                                                                    ...
                                                                    $link_active = base_url() . "tender/rincian_paket/$thn/$kelompok/$i/$limit/$getcari";
                                                        ...
                                                        <li class="page-item"><a href="<?= base_url(); ?>tender/rincian_paket/<?= "$thn/$kelompok/$link_next/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-step-forward"></i></a></li>
                                                        <li class="page-item"><a href="<?= base_url(); ?>tender/rincian_paket/<?= "$thn/$kelompok/$jumlah_page/$limit/$getcari";?>#divider" class="page-link"><i class="fa fa-fast-forward"></i></a></li>
                                                        <? } ?>
                                                    </ul>
                                                    <? } ?>
                                                </div>
