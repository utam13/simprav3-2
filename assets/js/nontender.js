...
function nontender(tahun) {  
    let table1 = $('#table_nontender_1').DataTable({
        "bProcessing": true,
        "bPaginate": false,
        "bLengthChange": false,
        "scrollX": false,
    ...
    $('#table_nontender_1 tfoot').empty();

    let table2 = $('#table_nontender_2').DataTable({
        "bProcessing": true,
        "bPaginate": false,
        "bLengthChange": false,
        "scrollX": false,
    ...
    $('#table_nontender_2 tfoot').empty();

    let table3 = $('#table_nontender_3').DataTable({
        "bProcessing": true,
        "bPaginate": false,
        "bLengthChange": false,
        "scrollX": false,
    ...
    $('#table_nontender_3 tfoot').empty();

    $.ajax({
        url: serverloc + '/nontender/nontender/'+tahun,
        type: 'get',
        dataType: 'JSON',
            ...
            if(response != ""){
                $.each(response, function (i, field) {
                    $.each(field.metode, function (i, metode) {
                        ...
                        $('#table_nontender_1 tfoot').append('<tr>'+
                                                            '<th scope="col">&nbsp;</th>'+
                    ...
                    $.each(field.jenis, function (i, jenis) {
                        ...
                        $('#table_nontender_2 tfoot').append('<tr>'+
                                                                '<th scope="col">&nbsp;</th>'+
                    ...
                    $.each(field.satker, function (i, satker) {
                        ...
                        $('#table_nontender_3 tfoot').append('<tr>'+
                                                            '<th scope="col">&nbsp;</th>'+
                                                            '<th scope="col" class="text-right">Total</th>'+
...
$('#thn_nontender').change(function(){
    ...
    $('#export_excel').attr('href',serverloc + '/laporan/proses/5/' + pilih);
    $('#export_excel2').attr('href',serverloc + '/laporan/proses/23/' + pilih);
    $('#export_excel3').attr('href',serverloc + '/laporan/proses/6/' + pilih);
